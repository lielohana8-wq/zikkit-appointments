...
export default function DocumentsPage() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: c.bg }}>
      ...
      <Dialog open={brandingOpen} onClose={() => setBrandingOpen(false)} PaperProps={{ sx: { borderRadius: 5, p: 3, maxWidth: 480, width: '100%' } }}>
      ...
      <Dialog open={!!preview} onClose={() => setPreview(null)} PaperProps={{ sx: { borderRadius: 4, maxWidth: 520, width: '100%' } }}>
